 ...
 * @author panwm
 */
@AutoConfiguration(after = OssAutoConfiguration4.class)
@ConditionalOnProperty(prefix = "oss", name = "enable", havingValue = "true")
public class OssWebAutoConfiguration4 {

    private static final Logger log = LoggerFactory.getLogger(OssWebAutoConfiguration4.class);
    ...
    public OssController4 ossController(OssTemplate template) {
        log.info("Initializing OSS HTTP endpoint (Boot4 Web Starter)");
