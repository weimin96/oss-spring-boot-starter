...
/**
 * `javax.validation` 命名空间 OpenAPI 自动配置契约测试。
 *
 * @param <T> 自动配置类型
 * @author panwm
 */
public abstract class AbstractJavaxOpenApiAutoConfigurationContractTest<T> {
    ...
    void documentedControllerInheritsMethodValidationConstraints() throws Exception {
