...
import com.wiblog.oss.config.handler.AbstractJavaxOssGlobalExceptionHandlerSupport;
...
/**
 * `javax.validation` 命名空间异常处理契约测试。
 *
 * @param <T> 异常处理器类型
 * @author panwm
 */
public abstract class AbstractJavaxOssGlobalExceptionHandlerContractTest<T extends AbstractJavaxOssGlobalExceptionHandlerSupport> {
