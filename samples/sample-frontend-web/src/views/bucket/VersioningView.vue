...
const {
  status: suspendVerStatus,
  result: suspendVerResult,
  error: suspendVerError,
  execute: execSuspendVer
} = useResult()
</script>
...
<template>
  <div>
    ...
    <div class="card mb-4">
      ...
      <ResultPanel :status="getVerStatus" :result="getVerResult" :error="getVerError"
                   label="版本控制状态（Enabled / Suspended / 空）"/>
