...
const {
  status: getObjTagStatus,
  result: getObjTagResult,
  error: getObjTagError,
  execute: execGetObjTag
} = useResult<Record<string, string>>()
...
const {
  status: mergeObjTagStatus,
  result: mergeObjTagResult,
  error: mergeObjTagError,
  execute: execMergeObjTag
} = useResult()
