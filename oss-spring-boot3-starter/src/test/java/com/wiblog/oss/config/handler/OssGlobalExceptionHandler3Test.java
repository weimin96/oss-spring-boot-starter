...
/**
 * OssGlobalExceptionHandler3 测试。
 */
@DisplayName("OssGlobalExceptionHandler3 异常处理器")
class OssGlobalExceptionHandler3Test {

    private final OssGlobalExceptionHandler3 handler = new OssGlobalExceptionHandler3();
