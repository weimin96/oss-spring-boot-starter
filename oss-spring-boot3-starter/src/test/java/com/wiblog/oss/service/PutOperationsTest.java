...
class PutOperationsTest extends AbstractServiceDynamicPropertyTest {
    ...
    void multipartUploadAndMerge() {
        ...
        firstChunk.setFile(new MockMultipartFile("file", "part1", "text/plain", firstPartBytes));
        ...
        secondChunk.setFile(new MockMultipartFile("file", "part2", "text/plain", "world".getBytes(StandardCharsets.UTF_8)));
