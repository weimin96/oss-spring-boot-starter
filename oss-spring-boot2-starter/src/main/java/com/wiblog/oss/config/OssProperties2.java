...
/**
 * Spring Boot 2.x OSS 配置属性。
 *
 * <p>继承 {@link OssProperties} 并添加 javax.validation 校验注解，
 * 绑定 {@code oss.*} 配置前缀。
 *
 * @author panwm
 */
...
@Schema(description = "OSS 客户端配置（Spring Boot 2）")
public class OssProperties2 extends OssProperties {
