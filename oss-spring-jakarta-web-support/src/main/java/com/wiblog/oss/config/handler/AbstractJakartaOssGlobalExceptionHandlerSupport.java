...
/**
 * `jakarta.validation` 体系共享的 OSS HTTP 异常处理实现。
 *
 * <p>Boot3 与 Boot4 的错误协议完全一致，因此统一收敛到该基类。
 * 版本 Starter 只负责挂上 `@RestControllerAdvice` 并暴露稳定类型。</p>
 *
 * @author panwm
 */
@Slf4j
public abstract class AbstractJakartaOssGlobalExceptionHandlerSupport {
