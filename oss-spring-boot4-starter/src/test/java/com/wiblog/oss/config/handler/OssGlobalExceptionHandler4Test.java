...
/**
 * OssGlobalExceptionHandler4 测试。
 *
 * <p>Boot4 的异常处理器使用了 jakarta.validation 和新语言特性，
 * 这里固定住返回协议，避免升级编译器和框架后错误响应结构发生无意变化。</p>
 */
@DisplayName("OssGlobalExceptionHandler4 异常处理器")
class OssGlobalExceptionHandler4Test {

    private final OssGlobalExceptionHandler4 handler = new OssGlobalExceptionHandler4();
