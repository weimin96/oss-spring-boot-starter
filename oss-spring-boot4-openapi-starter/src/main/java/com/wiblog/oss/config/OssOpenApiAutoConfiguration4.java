...
/**
 * Spring Boot 4.x OSS OpenAPI 自动配置。
 *
 ...
 * @author panwm
 */
@AutoConfiguration(after = OssAutoConfiguration4.class, before = OssWebAutoConfiguration4.class)
@ConditionalOnProperty(prefix = "oss", name = "enable", havingValue = "true")
public class OssOpenApiAutoConfiguration4 {

    private static final Logger log = LoggerFactory.getLogger(OssOpenApiAutoConfiguration4.class);
    ...
    public OpenApiOssController4 ossController(OssTemplate template) {
        log.info("Initializing OSS HTTP endpoint with OpenAPI metadata (Boot4)");
        return new OpenApiOssController4(template);
    }
}
